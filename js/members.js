...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document.getElementById("photo-upload-form").addEventListener("submit", async (e) => {
    ...
    for (const file of files) {
      ...
      const { error: uploadError } = await window.ImageResize.uploadPhoto(client, "gallery", path, file);
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  const { data: urlData } = client.storage.from("gallery").getPublicUrl(p.storage_path);
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      return `
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            <div class="gallery-item">
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    <img src="${client.storage.from('gallery').getPublicUrl('thumbs/' + p.storage_path).data.publicUrl}" data-full="${urlData.publicUrl}" onerror="this.onerror=null;this.src=this.dataset.full;" loading="lazy" alt="${escapeHtml(p.caption || '')}">
