                ...
                .map(p => {
                            ...
                            return "<tr><td>" + escapeHtml(p.players?.name || "Unknown") + "</td>" +
                                      ...
                                      return '<div class="scorecard" style="margin-top:24px;">' +
                                                ...
                                                "</p>" +
                                                '<style>#trip-payment-breakdown table.score-table td,#trip-payment-breakdown table.score-table th{white-space:nowrap;}#trip-payment-breakdown table.score-table td:first-child{white-space:normal;min-width:110px;}#trip-payment-breakdown .pay-status{white-space:nowrap;}@media (max-width:640px){#trip-payment-breakdown .pay-status{display:none;}#trip-payment-breakdown table.score-table{font-size:12px;}#trip-payment-breakdown table.score-table th,#trip-payment-breakdown table.score-table td{padding:6px 4px;}#trip-payment-breakdown table.score-table td:first-child{min-width:0;font-size:12px;}#trip-payment-breakdown input[data-amt]{width:52px !important;padding:3px 4px;font-size:12px;}#trip-payment-breakdown button[data-add]{padding:3px 7px !important;font-size:11px;}}</style><div style="overflow-x:auto;-webkit-overflow-scrolling:touch;"><table class="score-table" style="min-width:100%;"><thead><tr><th>Player</th>' +
